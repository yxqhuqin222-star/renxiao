...
class TestPipeline(unittest.TestCase):
    def test_compute_result_uses_existing_cost_rules(self):
        tongshi_rows = [
            ...
            {"日期": "2026-08-01", "模式": "爆量再植课", "学部": "小学", "AI接通数": 100, "例子数": 5, "话单分钟数": 50},
            {"日期": "2026-08-01", "模式": "爆量未加微", "学部": "高中", "AI接通数": 80, "例子数": 4, "话单分钟数": 40},
            {"日期": "2026-08-01", "模式": "爆量本地化", "学部": "初中", "AI接通数": 200, "例子数": 10, "话单分钟数": 100},
        ]
        zhuanhua_rows = [
            {"日期": "2026-08-01", "流转模式": "大神", "单量": 50, "出勤": 10},
            {"日期": "2026-08-01", "流转模式": "爆量算法池", "单量": 80, "出勤": 10},
            {"日期": "2026-08-01", "流转模式": "爆量再植课", "单量": 80, "出勤": 10},
            {"日期": "2026-08-01", "流转模式": "爆量未加微", "单量": 80, "出勤": 10},
