...
class TestPipeline(unittest.TestCase):
    def test_compute_result_uses_existing_cost_rules(self):
        tongshi_rows = [
            ...
            {"日期": "2026-08-01", "模式": "爆量再植课", "学部": "小学", "例子数": 5, "话单分钟数": 50},
            {"日期": "2026-08-01", "模式": "爆量未加微", "学部": "高中", "例子数": 4, "话单分钟数": 40},
        ...
        zhuanhua_rows = [
            ...
            {"日期": "2026-08-01", "流转模式": "爆量再植课", "人效": 8, "接通转化率": 0.02},
            {"日期": "2026-08-01", "流转模式": "爆量未加微", "人效": 8, "接通转化率": 0.02},
        ...
        self.assertAlmostEqual(by_key[("爆量再植课", "小学")][5], 40.85)
